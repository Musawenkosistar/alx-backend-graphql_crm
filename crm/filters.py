...
class CustomerFilter(django_filters.FilterSet):
    ...
    created_at_gte = django_filters.DateFilter(field_name="id", lookup_expr="gte")  # replace with actual created_at field if you add
    created_at_lte = django_filters.DateFilter(field_name="id", lookup_expr="lte")  # replace with actual created_at
